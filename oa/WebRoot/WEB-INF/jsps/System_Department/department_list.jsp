    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData">
			...
			<tr class="TableDetail1 template">
				...
				<td>
					<s:a action="departmentAction_departmentDelete.do" onclick="javascript:return window.confirm('您确定要删除｛%{name}｝这个部门吗？')">
						<s:param name="id" value="id"></s:param>
						删除
					</s:a>
					
					
					<s:a action="departmentAction_departmentUpdatePage.do">
						<s:param name="id" value="id"></s:param>
						修改
					</s:a>
				</td>

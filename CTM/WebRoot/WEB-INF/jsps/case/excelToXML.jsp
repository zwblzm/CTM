	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<s:include value="/WEB-INF/jsps/base/baseCatalog.jsp"></s:include>
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
								...
								<hr/>
								<s:actionerror/>
								<form action="${pageContext.request.contextPath}/fileManager_updateFile.do" method="POST" enctype="multipart/form-data">
								...
								<table border="1">
									...
									<tr>
										...
										<td><s:property value="#files[#index.index].name"/> </td>
										
										<td>
										<s:a action="fileManager_fileDownload.do">
										<s:param name="fileName" value="#files[#index.index].name"></s:param>
										<button>下载</button>
